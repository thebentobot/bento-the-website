...
export default function FeatureImagePreview({ features, right, left, title, subtitle, description, image }: FeatureImagePreviewProps) {
    return (
                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    <div className="lg:pr-8 lg:pt-4">
                        <div className="lg:max-w-lg">
                            {subtitle && <h2 className="text-base font-semibold leading-7 text-yellow-600">{subtitle}</h2>}
