	...
	return (
		<div className="overflow-hidden dark:bg-black bg-white">
			<div className="mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mx-auto grid max-w-2xl grid-cols-1 space-x-8 space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
					<div className="lg:pr-8 lg:pt-4">
						<div className="lg:max-w-lg">
							...
							{description && <p className="mt-4 text-lg leading-7 text-zinc-600 dark:text-gray-200">{description}</p>}
							<dl className="mt-10 max-w-xl flex flex-col gap-y-8 text-base leading-7 text-zinc-600 dark:text-gray-300 lg:max-w-none">
								{features.map((feature) => (
									<div key={feature.name} className="relative pl-9">
										<dt className="inline font-semibold text-zinc-900 dark:text-gray-50">
