...
export const LeaderboardPageSkeleton = ({ serverId }: { serverId?: string }) => {
	return (
		<Fragment>
			...
			{serverId && (
				<div className="animate-pulse bg-gray-900/50 mx-auto my-auto p-2 mt-8 w-64 rounded-sm shadow-lg">
					<div className="dark:bg-zinc-700 bg-zinc-300 w-64 h-64 rounded-sm mx-auto"></div>
				</div>
			)}
