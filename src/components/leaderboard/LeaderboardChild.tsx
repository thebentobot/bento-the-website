...
export default function LeaderboardChild({
	...
	return (
		<li className="transition duration-300 ease-in-out dark:bg-zinc-900 bg-zinc-100 flex items-center w-full my-4 p-2 px-4 rounded-lg group hover:bg-zinc-200 dark:hover:bg-zinc-800 shadow-xs overflow-hidden">
			...
			<div className="grow p-4 w-full md:w-auto overflow-hidden">
				...
				<div
					...
					className="transition duration-300 ease-in-out mt-1 mb-1 w-full h-1 dark:bg-zinc-700 dark:group-hover:bg-zinc-500 bg-zinc-300 group-hover:bg-zinc-400 rounded-sm overflow-hidden"
				>
					<div
