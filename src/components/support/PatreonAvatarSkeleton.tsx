...
export const PatreonAvatarSkeleton = ({ rank }: { rank: keyof typeof rankStyles }) => {
	...
	return (
		<div>
			<li
				className={`transition duration-300 ease-in-out dark:bg-zinc-900 bg-zinc-100 flex flex-wrap items-center ${style.width} my-4 px-4 rounded-lg shadow overflow-hidden`}
			>
